...
static NSString * const kMCSessionServiceType = @"vcinityp2p";

#pragma mark - Initializer

- (instancetype)initWithDelegate:(id<SessionControllerDelegate>)delegate
{
    self = [super init];
...
{
   return [_session sendData:data toPeers:_session.connectedPeers withMode:MCSessionSendDataReliable error:nil];
}

-(void)updateDelegateWithSessionChangeState
{
